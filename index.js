window.addEventListener('load', function () {
    ...
    class Particle {
        ...
        draw(context) {
            ...
            context.drawImage(this.image, this.frameX * this.spriteSize, this.frameY * this.
                spriteSize, this.spriteSize, this.spriteSize, this.size * -0.5, 0, this.size, this.size)
            context.restore();
        }
    }
    class Player {
    ...
    class HivWhale extends Enemy {
        constructor(game) {
            ...
            this.height = 277;
            this.y = Math.random() * (this.game.height * 0.95 - this.height);
            this.image = document.getElementById('hivWhale');
            this.frameY = 0;
            this.lives = 20;
            this.score = this.lives;
            this.type = 'hive';
    ...
    class Game {
                            ...
                            if (enemy.type === 'hive') {
                                for (let i = 0; i < 5; i++) {
                                    this.enemies.push(new Drone(this, enemy.x + Math.random() *
                                        enemy.width, enemy.y + Math.random() * enemy.height))
                                }
                            }
        ...
        addEnemy() {
            ...
            else if (randomize < 0.7) this.enemies.push(new HivWhale(this));
